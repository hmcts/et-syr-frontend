...
export const mapRespondents = (respondents: RespondentApiModel[]): Respondent[] => {
  ...
  return respondents.map(respondent => {
    return {
      ...
      respondentAddress: respondent.value?.respondent_address,
      respondentACASQuestion: respondent.value?.respondent_ACAS_question,
      respondentACAS: respondent.value?.respondent_ACAS,
      respondentACASNo: respondent.value?.respondent_ACAS_no,
      claimantWorkAddress: respondent.value?.claimant_work_address,
      responseReceived: respondent.value?.responseReceived,
      responseStatus: respondent.value?.response_status,
      responseToClaim: respondent.value?.responseToClaim,
      rejectionReason: respondent.value?.rejection_reason,
      rejectionReasonOther: respondent.value?.rejection_reason_other,
      responseOutOfTime: respondent.value?.responseOutOfTime,
      responseNotOnPrescribedForm: respondent.value?.responseNotOnPrescribedForm,
      responseRequiredInfoAbsent: respondent.value?.responseRequiredInfoAbsent,
      responseNotes: respondent.value?.responseNotes,
      responseReferredToJudge: respondent.value?.response_referred_to_judge,
      responseReturnedFromJudge: respondent.value?.response_returned_from_judge,
      ...
      respondentPhone1: respondent.value?.respondent_phone1,
      respondentPhone2: respondent.value?.respondent_phone2,
      respondentEmail: respondent.value?.respondent_email,
      respondentContactPreference: respondent.value?.respondent_contact_preference,
      responseStruckOut: respondent.value?.responseStruckOut,
      responseStruckOutDate: respondent.value?.responseStruckOutDate,
      responseStruckOutChairman: respondent.value?.responseStruckOutChairman,
      responseStruckOutReason: respondent.value?.responseStruckOutReason,
      responseRespondentAddress: respondent.value?.responseRespondentAddress,
      responseRespondentPhone1: respondent.value?.responseRespondentPhone1,
      responseRespondentPhone2: respondent.value?.responseRespondentPhone2,
      ...
      responseReceivedDate: respondent.value?.responseReceivedDate,
      responseReceivedCount: respondent.value?.responseReceivedCount,
      responseRespondentNameQuestion: respondent.value?.responseRespondentNameQuestion,
      responseRespondentName: respondent.value?.responseRespondentName,
      responseContinue: respondent.value?.responseContinue,
      responseCounterClaim: respondent.value?.responseCounterClaim,
      responseReference: respondent.value?.responseReference,
      extensionRequested: respondent.value?.extensionRequested,
      extensionGranted: respondent.value?.extensionGranted,
      extensionDate: respondent.value?.extensionDate,
      extensionResubmitted: respondent.value?.extensionResubmitted,
      et3Vetting: respondent.value?.et3Vetting,
      et3VettingCompleted: respondent.value?.et3VettingCompleted,
      et3ResponseIsClaimantNameCorrect: respondent.value?.et3ResponseIsClaimantNameCorrect,
      et3ResponseClaimantNameCorrection: respondent.value?.et3ResponseClaimantNameCorrection,
      et3ResponseRespondentCompanyNumber: respondent.value?.et3ResponseRespondentCompanyNumber,
      et3ResponseRespondentEmployerType: respondent.value?.et3ResponseRespondentEmployerType,
      et3ResponseRespondentPreferredTitle: respondent.value?.et3ResponseRespondentPreferredTitle,
      et3ResponseRespondentContactName: respondent.value?.et3ResponseRespondentContactName,
      et3ResponseDXAddress: respondent.value?.et3ResponseDXAddress,
      et3ResponseContactReason: respondent.value?.et3ResponseContactReason,
      et3ResponseHearingRepresentative: respondent.value?.et3ResponseHearingRepresentative,
      et3ResponseHearingRespondent: respondent.value?.et3ResponseHearingRespondent,
      et3ResponseEmploymentCount: respondent.value?.et3ResponseEmploymentCount,
      et3ResponseMultipleSites: respondent.value?.et3ResponseMultipleSites,
      et3ResponseSiteEmploymentCount: respondent.value?.et3ResponseSiteEmploymentCount,
      et3ResponseAcasAgree: respondent.value?.et3ResponseAcasAgree,
      et3ResponseAcasAgreeReason: respondent.value?.et3ResponseAcasAgreeReason,
      et3ResponseAreDatesCorrect: respondent.value?.et3ResponseAreDatesCorrect,
      et3ResponseEmploymentStartDate: respondent.value?.et3ResponseEmploymentStartDate,
      et3ResponseEmploymentEndDate: respondent.value?.et3ResponseEmploymentEndDate,
      et3ResponseEmploymentInformation: respondent.value?.et3ResponseEmploymentInformation,
      et3ResponseContinuingEmployment: respondent.value?.et3ResponseContinuingEmployment,
      et3ResponseIsJobTitleCorrect: respondent.value?.et3ResponseIsJobTitleCorrect,
      et3ResponseCorrectJobTitle: respondent.value?.et3ResponseCorrectJobTitle,
      et3ResponseClaimantWeeklyHours: respondent.value?.et3ResponseClaimantWeeklyHours,
      et3ResponseClaimantCorrectHours: respondent.value?.et3ResponseClaimantCorrectHours,
      et3ResponseEarningDetailsCorrect: respondent.value?.et3ResponseEarningDetailsCorrect,
      et3ResponsePayFrequency: respondent.value?.et3ResponsePayFrequency,
      et3ResponsePayBeforeTax: respondent.value?.et3ResponsePayBeforeTax,
      et3ResponsePayTakehome: respondent.value?.et3ResponsePayTakehome,
      et3ResponseIsNoticeCorrect: respondent.value?.et3ResponseIsNoticeCorrect,
      et3ResponseCorrectNoticeDetails: respondent.value?.et3ResponseCorrectNoticeDetails,
      et3ResponseIsPensionCorrect: respondent.value?.et3ResponseIsPensionCorrect,
      et3ResponsePensionCorrectDetails: respondent.value?.et3ResponsePensionCorrectDetails,
      et3ResponseRespondentContestClaim: respondent.value?.et3ResponseRespondentContestClaim,
      et3ResponseContestClaimDocument: respondent.value?.et3ResponseContestClaimDocument,
      et3ResponseContestClaimDetails: respondent.value?.et3ResponseContestClaimDetails,
      et3ResponseEmployerClaim: respondent.value?.et3ResponseEmployerClaim,
      et3ResponseEmployerClaimDetails: respondent.value?.et3ResponseEmployerClaimDetails,
      et3ResponseEmployerClaimDocument: respondent.value?.et3ResponseEmployerClaimDocument,
      et3ResponseRespondentSupportNeeded: respondent.value?.et3ResponseRespondentSupportNeeded,
      et3ResponseRespondentSupportDetails: respondent.value?.et3ResponseRespondentSupportDetails,
      et3ResponseRespondentSupportDocument: respondent.value?.et3ResponseRespondentSupportDocument,
      et3Form: respondent.value?.et3Form,
      personalDetailsSection: respondent.value?.personalDetailsSection,
      employmentDetailsSection: respondent.value?.employmentDetailsSection,
      claimDetailsSection: respondent.value?.claimDetailsSection,
      workAddress1: respondent.value?.workAddress1,
      workAddress2: respondent.value?.workAddress2,
