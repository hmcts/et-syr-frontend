...
export function formatApiCaseDataToCaseWithId(fromApiCaseData: CaseApiDataResponse, req?: AppRequest): CaseWithId {
  ...
  const caseWithId: CaseWithId = {
    ...
    et1OnlineSubmission: fromApiCaseData?.case_data?.et1OnlineSubmission,
...
export function mapResponseApiDataToCaseWithId(
  ...
  if (
    ObjectUtils.isEmpty(fromApiCaseData?.case_data) ||
    CollectionUtils.isEmpty(fromApiCaseData.case_data.respondentCollection) ||
    NumberUtils.isEmpty(req?.session?.selectedRespondentIndex) ||
    ObjectUtils.isEmpty(fromApiCaseData.case_data.respondentCollection[req.session.selectedRespondentIndex])
  ) {
    return;
  }
  ...
  if (ObjectUtils.isEmpty(selectedRespondent.value)) {
    return;
  }
  ...
  if (ObjectUtils.isNotEmpty(selectedRespondent.value.respondent_address)) {
  ...
  if (ObjectUtils.isNotEmpty(selectedRespondent.value.et3Vetting)) {
    ...
    if (ObjectUtils.isNotEmpty(selectedRespondent.value.et3Vetting.et3CompanyHouseDocument)) {
    ...
    if (ObjectUtils.isNotEmpty(selectedRespondent.value.et3Vetting.et3IndividualInsolvencyDocument)) {
    ...
    if (ObjectUtils.isNotEmpty(selectedRespondent.value.et3Vetting.et3VettingDocument)) {
  ...
  if (ObjectUtils.isNotEmpty(selectedRespondent.value.et3ResponseEmployerClaimDocument)) {
  ...
  if (ObjectUtils.isNotEmpty(selectedRespondent.value.et3ResponseRespondentSupportDocument)) {
  ...
  if (ObjectUtils.isNotEmpty(selectedRespondent.value?.et3Form)) {
  ...
  if (ObjectUtils.isNotEmpty(selectedRespondent.value.et3FormWelsh)) {
