...
export const mapRespondent = (respondent: RespondentType): RespondentET3Model => {
  return {
    ...
    et3FormBinaryUrl: respondent?.et3Form?.document_binary_url,
    et3FormFileName: respondent?.et3Form?.document_filename,
    et3FormUrl: respondent?.et3Form?.document_url,
    et3FormCategoryId: respondent?.et3Form?.category_id,
    et3FormUploadTimestamp: respondent?.et3Form?.upload_timestamp,
    et3FormWelsh: respondent?.et3FormWelsh,
    et3FormWelshBinaryUrl: respondent?.et3FormWelsh?.document_binary_url,
    et3FormWelshFileName: respondent?.et3FormWelsh?.document_filename,
    et3FormWelshUrl: respondent?.et3FormWelsh?.document_url,
    et3FormWelshCategoryId: respondent?.et3FormWelsh?.category_id,
    et3FormWelshUploadTimestamp: respondent?.et3FormWelsh?.upload_timestamp,
