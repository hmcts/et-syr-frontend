...
import { getContactPreferencesDetails } from '../helpers/ClaimantEarlyConciliationAndEmployeeDetailsCYAHelper';
...
export default class CheckYourAnswersEarlyConciliationAndEmployeeDetailsController {
  ...
  public get = (req: AppRequest, res: Response): void => {
    ...
    res.render(TranslationKeys.CHECK_YOUR_ANSWERS_EARLY_CONCILIATION_AND_EMPLOYEE_DETAILS, {
      ...content,
      hideContactUs: true,
      cyaDetails: getContactPreferencesDetails(req.session.userCase, {
        ...req.t(TranslationKeys.COMMON, { returnObjects: true }),
        ...req.t(TranslationKeys.CHECK_YOUR_ANSWERS_EARLY_CONCILIATION_AND_EMPLOYEE_DETAILS, { returnObjects: true }),
      }),
      PageUrls,
    });
  };
