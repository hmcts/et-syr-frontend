...
import { getAppNotifications, getStoredTseBannerList } from '../helpers/notification/ApplicationNotificationHelper';
...
export default class CaseDetailsController {
  public async get(req: AppRequest, res: Response): Promise<void> {
    ...
    res.render(TranslationKeys.CASE_DETAILS_WITH_CASE_ID_PARAMETER, {
      ...
      storedAppNotifications: getStoredTseBannerList(req),
