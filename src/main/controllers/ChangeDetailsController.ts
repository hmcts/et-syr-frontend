...
export default class ChangeDetailsController {
  public get = (req: AppRequest, res: Response): void => {
    ...
    if (req.query.redirect === 'respondent-contact-preferences') {
      ...
      return res.redirect(req.url.replace(InterceptPaths.EMPLOYER_DETAILS_CHANGE, languageParam));
      ...
      return res.redirect(req.url.replace(InterceptPaths.CONCILIATION_AND_EMPLOYEE_DETAILS_CHANGE, languageParam));
      ...
      return res.redirect(req.url.replace(InterceptPaths.PAY_PENSION_BENEFITS_CHANGE, languageParam));
      ...
      return res.redirect(req.url.replace(InterceptPaths.CONTEST_CLAIM_CHANGE, languageParam));
      ...
      return res.redirect(req.url.replace(InterceptPaths.EMPLOYERS_CONTRACT_CLAIM_CHANGE, languageParam));
    } // FINAL CYA Section
