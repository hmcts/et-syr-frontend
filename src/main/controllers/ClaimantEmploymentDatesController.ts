  ...
  private readonly formContent: FormContent = {
    fields: {
      areDatesOfEmploymentCorrect: {
        type: 'radios',
        label: (l: AnyRecord): string => l.areDatesOfEmploymentCorrect.label,
        values: [
          {
          ...
          },
          {
            ...
            hint: (l: AnyRecord): string => l.areDatesOfEmploymentCorrect.no.hint,
          },
          {
            label: (l: AnyRecord): string => l.notSure,
            value: YesOrNoOrNotSure.NOT_SURE,
            hint: (l: AnyRecord): string => l.areDatesOfEmploymentCorrect.notSure.hint,
          },
        ],
