...
export default class DocumentUtils {
   ...
   * To discriminate ET1 form checks if document type is ET1 or not. If it finds any document with type ET1 according
   * to the selected language returns document. If selected language is Welsh and not able to find any ET1 form
   * in Welsh but finds in English returns ET1 form in english.
