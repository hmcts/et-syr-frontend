...
export default class ET3DataModelUtil {
  ...
  public static convertSelectedRespondentToRespondentType(
    ...
    const respondentType: RespondentType = {
      ...
      personalDetailsSection: caseWithId.personalDetailsSection,
      employmentDetailsSection: caseWithId.employmentDetailsSection,
      claimDetailsSection: caseWithId.claimDetailsSection,
