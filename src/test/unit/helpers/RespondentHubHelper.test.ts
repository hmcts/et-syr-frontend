...
describe('getET3CaseDetailsLinksUrlMap', () => {
  const et3CaseDetailsLinksMapWelsh: Map<string, string> = new Map<string, string>([
    ...
    [
      ...
      PageUrls.YOUR_REQUEST_AND_APPLICATIONS + languages.WELSH_URL_PARAMETER,
    ],
    ...
    [ET3CaseDetailsLinkNames.TribunalNotification, PageUrls.NOT_IMPLEMENTED + languages.WELSH_URL_PARAMETER],
  ...
  const et3CaseDetailsLinksMapEnglish: Map<string, string> = new Map<string, string>([
    ...
    [ET3CaseDetailsLinkNames.TribunalNotification, PageUrls.NOT_IMPLEMENTED],
