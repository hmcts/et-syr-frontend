...
const pageJson = JSON.parse(
  fs.readFileSync(
    path.resolve(
      __dirname,
      '../../../main/resources/locales/en/translation/is-claimant-employment-with-respondent-continuing.json'
    ),
    'utf-8'
  )
);
...
describe('Is the claimant’s employment with the respondent continuing? page', () => {
  beforeAll(async () => {
