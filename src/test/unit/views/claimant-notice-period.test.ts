...
const pageJson = JSON.parse(
  fs.readFileSync(
    path.resolve(__dirname, '../../../main/resources/locales/en/translation/claimant-notice-period.json'),
    'utf-8'
  )
);

const PAGE_URL = '/claimant-notice-period';
...
describe('Claimant notice period page', () => {
  beforeAll(async () => {
