...
const pageJson = JSON.parse(
  fs.readFileSync(
    path.resolve(__dirname, '../../../main/resources/locales/en/translation/claimant-pension-and-benefits.json'),
    'utf-8'
  )
);

const PAGE_URL = '/claimant-pension-and-benefits';
...
describe('Claimant pension and benefits page', () => {
  beforeAll(async () => {
