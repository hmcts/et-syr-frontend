import CheckYourAnswersPayAndBenefitsController from '../../../main/controllers/CheckYourAnswersPayPensionAndBenefitsController';
...
describe('CheckYourAnswersPayAndBenefitsController', () => {
  let controller: CheckYourAnswersPayAndBenefitsController;
  ...
  beforeEach(() => {
    controller = new CheckYourAnswersPayAndBenefitsController();
    request = mockRequest({
      session: {
        userCase,
        selectedRespondent: {
