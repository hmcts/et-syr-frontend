import CopyToOtherPartyOfflineController from '../../../main/controllers/CopyToOtherPartyOfflineController';
...
describe('Copy to Other Party Offline Controller', () => {
  let controller: CopyToOtherPartyOfflineController;
  let request: ReturnType<typeof mockRequestWithTranslation>;
  let response: ReturnType<typeof mockResponse>;

  beforeEach(() => {
    controller = new CopyToOtherPartyOfflineController();
